...
chromedriver_path = 'G:\chromedriver_win32\chromedriver.exe' # Change this to your own chromedriver path!
...
for hashtag in hashtag_list:
    ...
    sleep(5)
    first_thumbnail = webdriver.find_element_by_xpath('//*[@id="react-root"]/section/main/article/div[1]/div/div/div[1]/div[1]')
        ...
        for x in range(1,200):
            ...
            if username not in prev_user_list:
                ...
                if webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[2]/button').text == 'Follow':
                    ...
                    # Liking the picture
                    button_like = webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/div[2]/section[1]/span[1]')
